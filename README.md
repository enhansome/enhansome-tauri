...
* [create-tauri-app](https://github.com/tauri-apps/create-tauri-app) ⭐ 1,632 | 🐛 28 | 🌐 Rust | 📅 2026-09-24 ![officially maintained] - Rapidly scaffold your Tauri app.
...
* [tauri-nextjs-template](https://github.com/kvnxiao/tauri-nextjs-template) ⭐ 692 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-19 ![v2] - Next.js (SSG) template, with TailwindCSS, opinionated linting, and GitHub Actions preconfigured.
* [tauri-vue-template](https://github.com/Uninen/tauri-vue-template) ⭐ 488 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-24 ![v2] - Vue template with TypeScript, Vite + HMR, Vitest, Tailwind CSS, ESLint, and GitHub Actions.
...
* [tauri-solid-ts-tailwind-vite-template](https://github.com/AR10Dev/tauri-solid-ts-tailwind-vite) ⭐ 302 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-25 ![v2] - SolidJS Template preconfigured to use Vite, TypeScript, Tailwind CSS, ESLint and Prettier.
...
* [tauri-clojurescript-template](https://github.com/rome-user/tauri-clojurescript-template) ⭐ 118 | 🐛 0 | 🌐 Clojure | 📅 2023-10-23 ![v1] - Minimal ClojureScript template with Shadow CLJS and React.
...
* [tauri-sveltekit-template](https://github.com/deid84/tauri-sveltekit-admin-template) ⭐ 114 | 🐛 0 | 🌐 Svelte | 📅 2024-06-25 ![v1] - SvelteKit Admin template with cross-platform GitHub action builds, Vite, TypeScript, Svelte Preprocess, hot module replacement, ESLint and Prettier.
...
* [oxide-dock](https://github.com/fridzema/oxide-dock) ⭐ 99 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-24 ![v2] - Vue 3 with Vite, Tailwind CSS, typed Rust bridge, Vitest, Playwright, coverage-gated Rust tests, and automated cross-platform releases via `release-please`.
...
* [Official Plugins](https://github.com/tauri-apps/plugins-workspace) ⭐ 1,816 | 🐛 518 | 🌐 Rust | 📅 2026-09-24 ![officially maintained] - This repository contains all the plugins maintained by the Tauri team. This includes plugins for NFC, logging, notifications, and more.
* [window-vibrancy](https://github.com/tauri-apps/window-vibrancy) ⭐ 1,037 | 🐛 19 | 🌐 Rust | 📅 2026-09-22 ![officially maintained] - Make your windows vibrant (v1 only - added to Tauri in v2).
...
* [tauri-plugin-context-menu](https://github.com/c2r0b/tauri-plugin-context-menu) ⭐ 237 | 🐛 0 | 🌐 Rust | 📅 2024-10-26 ![v1] - Native context menu.
...
* [tauri-plugin-blec](https://github.com/MnlPhlp/tauri-plugin-blec) ⭐ 228 | 🐛 8 | 🌐 Rust | 📅 2026-09-22 ![v2] - Cross platform Bluetooth Low Energy client based on `btleplug`.
...
* [tauri-plugin-graphql](https://github.com/JonasKruckenberg/tauri-plugin-graphql) ⭐ 162 | 🐛 52 | 🌐 Rust | 📅 2026-09-24 ![v1] - Type-safe IPC for Tauri using GraphQL.
...
* [tauri-plugin-cache](https://github.com/Taiizor/tauri-plugin-cache) ⭐ 122 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 ![v2] - Advanced disk caching solution with memory layer, TTL management, compression support, and cross-platform compatibility for desktop and mobile.
...
* [tauri-plugin-velesdb](https://github.com/cyberlife-coder/VelesDB) ⭐ 95 | 🐛 33 | 🌐 Rust | 📅 2026-09-25 ![v2] - Native vector database plugin. 70µs semantic search, ≥95% recall, hybrid BM25+vector, offline-first, full ecosystem integrations and more.
...
* [tauri-plugin-iap](https://github.com/Choochmeque/tauri-plugin-iap) ⭐ 81 | 🐛 10 | 🌐 Rust | 📅 2026-09-23 ![v2] - Plugin that enables full In-App Purchases flow for Android, macOS, iOS and Windows.
...
* [Astrodon](https://github.com/astrodon/astrodon) ⭐ 1,022 | 🐛 11 | 🌐 TypeScript | 📅 2023-03-26 ![v1] - Make Tauri desktop apps with Deno.
* [Tauri Specta](https://github.com/oscartbeaumont/tauri-specta) ⭐ 801 | 🐛 32 | 🌐 Rust | 📅 2026-07-26 ![v2] - Completely typesafe Tauri commands.
* [tauri-macos-menubar-app-example](https://github.com/ahkohd/tauri-macos-menubar-app-example) ⭐ 389 | 🐛 1 | 🌐 Rust | 📅 2026-09-19telemetry - Example macOS Menubar app project.
* [tauri-mcp-server](https://github.com/hypothesi/mcp-server-tauri) ⭐ 308 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-28 ![v2] - MCP server and plugin for rapid development and debugging.
...
* [faynosync-update-server](https://github.com/ku9nov/faynoSync) ⭐ 157 | 🐛 2 | 🌐 Go | 📅 2026-09-24 ![v2] - Self-hosted Dynamic Update Server with statistics, supporting Tauri and other platforms. Flexible features for seamless app updates and insights.
